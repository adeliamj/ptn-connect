            ...
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        <a href="homeadmin" class="nav-item nav-link">Home</a>
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link navbar-right" href="profiladmin">
                    ...
                    <div class="row g-5 py-5">
                        <div class="col-lg-6 text-center text-lg-start">
                            ...
                            <p class="text-white pb-3 animated zoomIn">Website terbaik untuk menentukan masa depan
                                kuliah Anda</p>
                            <a href="{{ route('hasiladmin') }}"
                                class="btn btn-light py-sm-3 px-sm-5 rounded-pill me-3 animated slideInLeft">Cek Hasil</a>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="team-item">
                            <div class="d-flex">
                                ...
                                <img class="img-fluid rounded w-100" src="img/dafa.jpg" alt="">
                            </div>
                            <div class="px-4 py-3">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="team-item">
                            <div class="d-flex">
                                ...
                                <img class="img-fluid rounded w-100" src="img/maul.jpg" alt="">
                            </div>
                            <div class="px-4 py-3">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.6s">
                        <div class="team-item">
                            <div class="d-flex">
                                ...
                                <img class="img-fluid rounded w-100" src="img/ammar.jpg" alt="">
                            </div>
                            <div class="px-4 py-3">
