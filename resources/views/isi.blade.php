            ...
            <div class="container mt-5 data">
                <form method="POST" action="{{ route('data.store') }}">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-10 ">
                            <input type="text" class="form-control ms-2 @error('nama') is-invalid @enderror" id="nama" name="nama" value="{{ old('nama') }}" autocomplete="off" >
                            @error('nama')
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-10">
                            <input type="text" class="form-control ms-2 @error('asal') is-invalid @enderror" id="asal" name="asal" value="{{ old('asal') }}">
                            @error('asal')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-10">
                            <select class="jurusan form-control ms-2 @error('jurusan') is-invalid @enderror" id="jurusan" name="jurusan">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col">
                            <input type="text" class="form-control ms-4 @error('nilai1') is-invalid @enderror" id="nilai1" name="nilai1" value="{{ old('nilai1') }}">
                            @error('nilai1')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col">
                            <input type="text" class="form-control ms-4 @error('nilai2') is-invalid @enderror" id="nilai2" name="nilai2" value="{{ old('nilai2') }}">
                            @error('nilai2')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <h4 class="mt-5" align="left">Kuesioner</h4>
                        ...
                        <div class="row mt-4">
                            <div class="col-2">
                                <label for="prodi1" class="form-label">Prodi pilihan: </label>
                            </div>
                            <div class="col">
