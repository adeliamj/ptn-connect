...
<head>
    ...
    <link href=rel="stylesheet" integrity="sha384-rbsA2VBKQhggwzxH7pPCaAqO46MgnOM80zW1RWuH61DGLwZJEdK2Kadq2F9CUG65"
            ...
            <form action="{{ route('reset-password') }}" method="POST">
                ...
                <div class="form-content">
                    ...
                    <div class="field input-field">
                        <input type="email" class="input" placeholder="Email" class="form-control" id="email"
                            name="email" value="">
                        @error('email')
                    ...
                    <div class="field">
                        <div class="input-field">
                            <input type="password" placeholder="Create New Password" class="form-control" id="password1" name="password1" value="{{ old('password1') }}">
