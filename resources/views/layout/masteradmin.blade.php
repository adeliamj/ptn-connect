...
<body>
    <nav class="navbar navbar-expand-lg bg-nav shadow-sm ms-auto">
        <div class="container">
            <a class="navbar-brand" href="admin">PTN-Connect</a>
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link active" href="{{ route('hasiladmin') }}">Hasil</a>
                        </li>
                    </ul>

                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link active navbar-right" href="profiladmin">
